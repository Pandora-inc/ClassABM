 ...
 *--------------------------------------------------------------------
 * $Id: BCGcode128.barcode.php,v 1.18 2010/02/14 00:24:07 jsgoupil Exp $
 *--------------------------------------------------------------------
...
class BCGcode128 extends BCGBarcode1D
{
	...
	// Array of method available to create PDF417 (PDF417_TM, PDF417_NM, PDF417_BM)
	...
	/**
	 * Specifies the start code.
	 * Can be 'A', 'B', 'C' or NULL
	...
	public function parse($text)
	{
		...
		else
		{
			...
			{ // We take each value
				...
				{ // This is not a table
					if (is_string ($val1))
					{ // If it's a string, parse as unknown
	 ...
	 * this method will return the code stream in an array.
	 * Each char will be a
