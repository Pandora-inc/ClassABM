...
abstract class BCGBarcode1D extends BCGBarcode
{
	...
	public function getMaxSize()
	{
		...
		return array (
				$p[0],
				$p[1] + $this->thickness * $this->scale + $textHeight
		);
	}
	...
	/**
	 * Draws all chars thanks to $code.
	 * if $start is true, the line begins by a space.
	...
	/**
	 * Method that saves FALSE into the checksumValue.
	 * This means no checksum
	...
	/**
	 * Returns FALSE because there is no checksum.
