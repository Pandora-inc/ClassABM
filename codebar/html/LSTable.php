...
class LSTable
{
	 ...
	 * @param string $width
	 * @param object $parent
	 *        	Constructor. You can put a $parent object. This will search the first empty place into the parent.
	 */
	 ...
	 * @param int $col
	 * @param mixed $string
	 *        	Writes Text or Object into $row and $col.
	 */
	 ...
	 * @param string $attrib
	 * @param mixed $value
	 *        	Adds a Cell Attribute at $row and $col.
	 */
	 ...
	 * @param int $col
	 * @param string $attrib
	 *        	Deletes a Cell Attribute at $row and $col.
	 */
	 ...
	 * @param string $attrib
	 * @param mixed $value
	 *        	Adds a Row Attribute at $row. Will be located in TR.
	 */
	 ...
	 * @param int $row
	 * @param string $attrib
	 *        	Deletes a Row Attribute at $row.
	 */
	 ...
	 * @param string $attrib
	 * @param mixed $value
	 *        	Adds a Cell Attribute in all cells located on $row row.
	 */
	 ...
	 * @param string $attrib
	 * @param mixed $value
	 *        	Adds a Cell Attribute in all cells located on $col column.
	 */
	...
	/**
	 *
	 * @return string Returns current Template
	 */
	 ...
	 * @param int $row
	 * @param int $col
	 *        	Returns the text or object contained into $row and $col
	 */
	 ...
	 * @param int $row
	 * @param int $col
	 *        	Clears the cell located into $row and $col. Keeps the Cell.
	 */
	 ...
	 * @return bool
	 * @param int $col
	 *        	Returns TRUE if a col is hidden.
	 */
	 ...
	 *        	Swaps 2 rows. Swaps attributes if $switchAttributes is TRUE.
	 */
	 ...
	 * @param int $col2
	 * @param bool $swapAttributes
	 *        	Swaps 2 cols. Swaps attributes if $switchAttributes is TRUE.
	 */
	 ...
	 * @param int $col2
	 * @param bool $swapAttributes
	 *        	Swaps 2 cells. Swaps attributes if $switchAttributes is TRUE.
	 */
	 ...
	 * @param int $row
	 * @param int $count
	 *        	Inserts $count row at $row position.
	 */
	 ...
	 * @param int $col
	 * @param int $count
	 *        	Inserts $count columns at $col position.
	 */
	...
	/**
	 *
	 * @return string Returns Table Width.
	 */
	...
	/**
	 *
	 * @return string Returns Table Title.
	 */
	...
	/**
	 *
	 * @return void Displays the table with its cells.
	 */
	...
	/**
	 *
	 * @return void Sets NULL to cells if colspan or rowspan go on the cells
	 */
	 ...
	 * @return void
	 * @param int $r
	 *        	Sets Default Variables for row $r.
	 */
	 ...
	 * @return void
	 * @param int $r
	 *        	Unsets Default Variables for row $r.
	 */
