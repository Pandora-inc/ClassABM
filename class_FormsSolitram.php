...
class Formularios {
     ...
     * 
     * @param array data_update -->El array de datos se maneja con indices y valores ej:$datos['PERSON'] ='alumno'
     * @param strin tabla  -->tabla a actualizar
     ...
     * 
     * @param array  data_update->datos a insertar en la tabla
     * @param string tabla->nombre de tabla
     * 
     * @return bool
     * 
     * campos tabla historial formularios :
        ...
        if ($tipo <= '100') {
            ...
            if (!$data) {
                ...
                switch ($tipo) {
                    ...
                    case '43':
                        $template.='<label>'
                                . '<b>Fecha de &uacute;ltima asistencia</b>'
                                . '</label>'
                                . '<input type="hidden" value="43" name="tipoform" id="tipoform">'
                                . '<input type="date" name="fecha_1" id="fecha_1" class="fecha" value="' . date("Y-m-d") . '" required>'
                                . '<label for="fecha_1_error" id="fecha_1_error" ></label>'
                                . '<p class="recordatorio_ayuda">La &uacute;ltima fecha registrada en el sistema es 21/12/2018</p><br/>'
                                . '<label>En el presente periodo lectivo, no rendir&aacute; ni cursar&aacute; asignatura alguna, '
                                . 'correspondiente a la carrera mencionada,'
                                . ' dejando constancia de la fecha en la que'
                                . ' ha dejado de hacerlo.</label>';
                        break;

                    case '86':

                        $template.='<input type="hidden" value="86" name="tipoform">'
                                . '<label><b>Curso hasta el: </b></label>'
                                . '<input type="date" style="width: 100% !important;" value="' . date("Y-m-d") . '" name="fecha_1" id="fecha_1" class="valid fecha" aria-invalid="true">'
                                . '<label>Del corriente a&ntilde;o, rendir&aacute; ex&aacute;menes finales.</label>'
                                . '<label for="fecha_1_error" id="fecha_1_error" ></label>';
                    ...
                    case '01':
                        ...
                        $template.='<input type="hidden" value="01" name="tipoform">'
                                . '<label><b>Cursar&aacute; regularmente durante el a&ntilde;o:</b>'
                                . '<input type="number" value="' . date("Y") . '" name="anio_cursa" id="anio_cursa" class="fecha" '
                                . 'min="' . $min . '" max="' . $max . '" >'
                    ...
                    case '07':
                        ...
                        $template.='<label>Los alumnos regulares que cursen obligaciones acad&eacute;micas por un total de '
                                . '162 horas reales totales, anuales, abonaran el 50% del arancel vigente correspondiente al '
                                . 'alumno de curso completo. La constancia correspondiente debe ser presentada hasta el 30 de abril,'
                                . ' caso contrario no tendr&aacute; efectos retroactivos.</label><input type="hidden" value="07" name="tipoform">'
                                . '<br/><br/><label><b>Cursar&aacute; la/s siguiente/s materia/s: </b></label>';

                        break;

                    case '05':

                        $template.='<input type="hidden" value="05" name="tipoform">'
                                . '<label> Los alumnos regulares que cursen obligaciones acad&eacute;micas '
                                . 'por un total inferior a 90 horas reales totales cuatrimestrales, abonaran el 50% del'
                                . ' arancel correspondiente al alumno que cursa únicamente primero o segundo cuatrimestre.'
                                . ' La constancia correspondiente debe ser presentada el 30 de abril por el primer cuatrimestre '
                                . 'y hasta el 31 de agosto, por el segundo cuatrimestre, caso contrario no tendr&aacute; efectos retroactivos.'
                                . ' No pueden combinarse los planes (cuota completa y media cuota) entre primero y segundo cuatrimestre.<br/><br/></label>'
                                . '<label><b>Cursar&aacute; la/s siguiente/s materia/s: </b></label>';

                        break;

                    case '06':

                        $template.='<input type="hidden" value="06" name="tipoform">'
                                . '<label> Los alumnos regulares que cursen obligaciones acad&eacute;micas'
                                . ' por un total inferior a 90 horas reales totales cuatrimestrales, abonaran el 50% del arancel '
                                . 'correspondiente al alumno que cursa únicamente primero o segundo cuatrimestre. '
                                . 'La constancia correspondiente debe ser presentada el 30 de abril por el primer cuatrimestre y hasta '
                                . 'el 31 de agosto, por el segundo cuatrimestre, caso contrario no tendr&aacute; efectos retroactivos.'
                                . ' No pueden combinarse los planes (cuota completa y media cuota) entre primero y segundo cuatrimestre.<br/><br/></label>'
                                . '<label><b>Cursar&aacute; la/s siguiente/s materia/s: </label></b>';

                        break;

                    case '49':

                        $anios_posibles = array(date('Y'), date('Y') + 1);

                        $template.='<input type="hidden" value="49" name="tipoform">'
                                . '<label> Alumnos que no cursan un ciclo lectivo,'
                                . ' o han finalizado la cursada de la carrera y deben rendir materias en el turno de '
                                . 'febrero y marzo sin abonar matricula.</label>'
                                . '<br/><br/><label>Solicito rendir en el turno de Febrero/Marzo sin matricularse en el a&ntilde;o</label>'
                    ...
                    case '58':
                        $template.='<input type="hidden" value="58" name="tipoform">'
                                ...
                                . '<option value="60">60 - Interes claus.4ø  </option>'
                                ...
                                . '</select>'
                                . '<label for"importe">Importe</label><input type="number" name="importe" step="0.01"/><br/>'
                                . '<label for"importeFT">Fuera de t&eacute;rmino</label><input type="number" name="importeFT" step="0.01" value=0/><br/>'
                                . '<label for"importeR">Recargo</label><input type="number" name="importeR" step="0.01" value=0/><br/>'
                ...
                switch ($tipo) {
                    ...
                    case '86':
                        ...
                        $template.='<input type="hidden" value="86" name="tipoform">'
                                . '<label><b>Curso hasta el: </b></label>'
                                . '<input disabled type="date" style="width: 100% !important;" value="' . date("Y-m-d", strtotime($data["CURSOHASTA"])) . '" name="fecha_1" id="fecha_1" class="valid fecha" aria-invalid="true">'
                                . '<label>Del corriente a&ntilde;o, rendir&aacute; ex&aacute;menes finales.</label>'
                                . '<label for="fecha_1_error" id="fecha_1_error" ></label>';
                    ...
                    case '01':
                        ...
                        $template.=''
                                . '<input  type="hidden" value="01" name="tipoform">'
                                . '<input  type="hidden" value="' . $data["ANIOCURSAREGULAR"] . '" name="anio_cursa" name="tipoform">'
                                . '<label><b>Cursar&aacute; regularmente durante el a&ntilde;o:</b>'
                                . '<input disabled type="number" value="' . $data["ANIOCURSAREGULAR"] . '" name="anio_cursa2" id="anio_cursa" class="fecha" '
                                . 'min="' . $min . '" max="' . $max . '" >'
                                . '<label for="anio_cursa_error" id="anio_cursa_error" ></label>';
                    ...
                    case '07':
                        ...
                        $template.='<label>Los alumnos regulares que cursen obligaciones acad&eacute;micas por un total de '
                                ...
                                . ' caso contrario no tendr&aacute; efectos retroactivos.</label><input type="hidden" value="07" name="tipoform">'
                                . '<br/><br/><label>'
                                . '<input type="hidden" value="07" name="tipoform">'
                                . '<label><b>Cursar&aacute; la/s siguiente/s materia/s: </b></label>';
                    ...
                    case '05':
                        ...
                        $template.='<label> Los alumnos regulares que cursen obligaciones acad&eacute;micas '
                                . 'por un total inferior a 90 horas reales totales cuatrimestrales, abonaran el 50% del'
                                . ' arancel correspondiente al alumno que cursa únicamente primero o segundo cuatrimestre.'
                                . ' La constancia correspondiente debe ser presentada el 30 de abril por el primer cuatrimestre '
                                . 'y hasta el 31 de agosto, por el segundo cuatrimestre, caso contrario no tendr&aacute; efectos retroactivos.'
                                . ' No pueden combinarse los planes (cuota completa y media cuota) entre primero y segundo cuatrimestre.<br/><br/></label>'
                                . '<label>'
                                . '<input type="hidden" value="05" name="tipoform">'
                                . '<label><b>Cursar&aacute; la/s siguiente/s materia/s: </b></label>';
        ...
        if ($tipo == '90' || $tipo == '07' || $tipo == '05' || $tipo == '06' || $tipo == '111' || $tipo == '112') {
            ...
            if ($tipo == '90' || $tipo == '07') {
                ...
                $aprobadas = $alumno->MateriasAprxPlanCarrera(
                        $alumno->get_person(), $alumno->get_carrera(), $alumno->get_plan(), $estados
                );
            } else if ($tipo == '05') {
                ...
                $aprobadas = $alumno->MateriasAprxPlanCarrera(
                        $alumno->get_person(), $alumno->get_carrera(), $alumno->get_plan(), $estados, 0
                );
            } else if ($tipo == '06') {
                ...
                $aprobadas = $alumno->MateriasAprxPlanCarrera(
                        $alumno->get_person(), $alumno->get_carrera(), $alumno->get_plan(), $estados, 1
                );
            } else {
            ...
            if ($aprobadas != "") {
                ...
                if (!$data) {
                    ...
                    $template.='<input type="hidden" value="90" name="tipoform">'
                            . '<label for="check"> Se matricula como alumno/a a egresar o complementario, debiendo rendir '
                            . 'solo ex&aacute;menes finales, correspondientes a las siguientes asignaturas: </label> <br/>'
                            . '<ul id="listado_materias">';
    ...
    public function get_materias($IDFORMULARIO) {
        ...
        $query = " select * from FORMULARIOMATERIAS "
                . "WHERE IDFORMULARIO = :idform order by id desc";
        $fila = '';
        $result = $this->db->query($query, $esParam = true, $parametros);
