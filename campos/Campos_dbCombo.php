...
$(document).ready(function() {
    ...
    public function generar_elemento_form_nuevo(): string
    {
        ...
        while ($filaCombo = $this->db->fetch_array ($resultCombo))
        {
            ...
            $imprForm .= "<option ".(( $filaCombo[strtoupper ($this->getCampoValor ())] == $this->getValorPredefinido())?"selected='true'":"")." value='" . $filaCombo[strtoupper ($this->getCampoValor ())] . "' >" . $combobit . "</option> \n";
        }
        $imprForm .= "</select> \n";
