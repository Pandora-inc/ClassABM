 ...
 *
 */
use function FuncionesString\remplazar_caracteres_latinos;
use function Sitios\agregarLinksEmail;
use function Sitios\createPath;
use function Sitios\delTree;
use function Sitios\filesToArray;
use function Sitios\formatearLinks;
use function Sitios\getHostNameEmail;
use function Sitios\redirect_http;
...
<?php
    ...
    /**
     * Resibe un int con la cantidad de meses y retorna un string con la cantidad de a�os y meses.
     *
     * @deprecated Se recomienda utilizar directamente la funcion de la clase Fechas
     *
     * @param int $meses
     *            Cantidad de meses
     * @return string - XxXx a�os y XxXx meses.
     */
